...
/// <summary>
/// Accumulating spawner that accumulates objects and spawns them after a certain time period.
/// </summary>
/// <typeparam name="T">Type of the object to be accumulated.</typeparam>
